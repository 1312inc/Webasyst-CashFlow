...
export default function (data) {
    ...
    function renderCharts () {
        ...
        const colors = {
            ...data.all_income[activeCurrencies.name]?.data.colors || {},
            ...data.all_expense[activeCurrencies.name]?.data.colors || {}
        }

            ;[...data.all_income[activeCurrencies.name]?.data.columns || [],
            ...data.all_expense[activeCurrencies.name]?.data.columns || []].forEach(category => {
