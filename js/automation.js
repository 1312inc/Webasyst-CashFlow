...
$.extend($.automation = $.automation || {}, {
    ...
    Init: function (options) {
        let that = this;
        let new_rule_id = -1;
        let $form = $('#c-settings-assignment-rules-form');
        const $table_tbody = $('#c-settings-order-assignments tbody').first();
        ...
        $('#c-settings-add-rule').on('click', function (event) {
        ...
        $table_tbody.on('click', '.c-delete-assignment', function (event) {
            event.preventDefault();
