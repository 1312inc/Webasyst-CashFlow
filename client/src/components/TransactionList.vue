<template>
  <div>
    <div class="flex my-6 justify-between">
      <div class="flex">
      <div class="mr-4">
        <button @click="addTransaction('income')" type="button" class="inline-flex items-center px-4 py-2 border  border-solid border-transparent  border border-solid leading-5 font-medium rounded-md text-white text-base bg-green-600 hover:bg-green-500 focus:outline-none focus:shadow-outline-green focus:border-green-700 active:bg-green-700 transition duration-150 ease-in-out">
          Добавить приход
        </button>
      </div>
      <div>
        <button @click="addTransaction('expense')" type="button" class="inline-flex items-center px-4 py-2 border  border-solid border-transparent  border border-solid leading-5 font-medium rounded-md text-white text-base bg-red-600 hover:bg-red-500 focus:outline-none focus:shadow-outline-red focus:border-red-700 active:bg-red-700 transition duration-150 ease-in-out">
          Добавить расход
        </button>
      </div>
      </div>
      <div>
        ...
        <span class="-ml-px relative inline-flex items-center px-4 py-2 border  border-solid border-gray-300 bg-white  border border-solid leading-5 font-medium text-gray-700">
          ...
        </span>
        <a href="#" class="-ml-px relative inline-flex items-center px-4 py-2 border  border-solid border-gray-300 bg-white  border border-solid leading-5 font-medium text-gray-700 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
          9
